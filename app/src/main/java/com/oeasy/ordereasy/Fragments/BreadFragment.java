...
/**
 * Created by Pk1409 on 4/15/2018.
 */

public class BreadFragment extends BaseFragment implements NoInternetInterface,MenuBtmSearchInterface{
    private ArrayList<FoodItem> breadList=new ArrayList<>();
    ...
    private void setRecView(RecyclerView rView) {
        ...
        adapter=setAdapter(getContext(),breadList,rView);
    }

    private void initialize(View view) {
        rView=view.findViewById(R.id.bread_rview);
        pBar=view.findViewById(R.id.menu_bread_progress);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < fType.length(); i++) {
                        ...
                        if(fItem.getType()==Constants.BREADS){
                            breadList.add(fItem);
