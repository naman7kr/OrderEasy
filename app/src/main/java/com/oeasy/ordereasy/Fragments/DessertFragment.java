...
public class DessertFragment extends BaseFragment implements NoInternetInterface,MenuBtmSearchInterface{
    private ArrayList<FoodItem> desList=new ArrayList<>();
    ...
    private void setRecView(RecyclerView rView) {
        ...
        adapter=setAdapter(getContext(),desList,rView);
    }

    private void initialize(View view) {
        rView=view.findViewById(R.id.dessert_rview);
        pBar=view.findViewById(R.id.menu_dessert_progress);
